<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebApplication1.registration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="reg-box">
        ...
        <a style="align-self:flex-start; color:orange;" href="Login.aspx">< Go To Login Page</a>
        <div class="login-container">
             <div class="jumbotron">
                 <div class="mb-3">
                     <label for="Name" class="form-label text">Name</label>
                     <asp:TextBox ID="txtName" runat="server" CssClass="form-control text" placeholder="John Doe" Style="width:20vw"></asp:TextBox>
                 </div>
                 <br />
                 <div class="mb-3">
                 ...
                 <div class="mb-3">
                     ...
                     <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control text" placeholder="Password" Style="width:20vw"></asp:TextBox>
                 </div>
                 <br />
             </div>
             <div class="jumbotron">
                 <div class="mb-3">
                     ...
                     <asp:TextBox ID="txtPhone" runat="server" CssClass="form-control text" placeholder="+60 123 456 78" Style="width:20vw"></asp:TextBox>
                 </div>
                 <br />
                 <div class="mb-3">
                     <label for="Address" class="form-label text">Address</label>
                     <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control text" placeholder="Endah Villa, Kuala Lumpur, Sri Petaling, 57000" Style="width:20vw"></asp:TextBox>
                 </div>
             </div>
        </div>
        <div class="submission">
            <asp:Button ID="btnRegister" runat="server" Text="Register" OnClick="btnRegister_Click" CssClass="text"/>
            <br />
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
             DeleteCommand="DELETE FROM [Customers] WHERE [id] = @id" InsertCommand="INSERT INTO [Customers] ([name], [email],
             [password], [dtAdded], [active],[address],[phone]) VALUES (@name, @email, @password, @dtAdded, @active, @address, @phone)" 
             SelectCommand="SELECT * FROM [Customers]" UpdateCommand="UPDATE [Customers] SET [name] = @name, [email] = @email, 
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="active" Type="Int32" DefaultValue="1" />
            </InsertParameters>
            <UpdateParameters>
